...
c=paste0(a,a,a,b)
print(c)
str_extract(addresses,pattern = c)
```
...
str_view_all(addresses,"[0-9]+號[0-9]+樓") # 樓號也會選到
```
...
a="https://github.com/"
b="/108-2-56-inclass-practice"
regex_pattern="(?<=https://github.com/)[0-9a-zA-Z]+(?=/108-2-56-inclass-practice)"
str_detect(studentGithubURLs,regex_pattern)
```
